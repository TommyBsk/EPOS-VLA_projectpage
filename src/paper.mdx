...
This project page summarizes **EPOS-VLM**, our memory-augmented vision–language agent for **consistent object-level captions** during embodied exploration: motivation, method overview, key results, and qualitative **HM3D test** trajectories. Figures and tables are presented in a **light** theme so the layout matches the paper and renders reliably on all displays.
...
**Object-level captioning and consistency (HM3D test, excerpt).** Higher is better except IQR (lower is better).

| Model | CIDEr | SPICE | CS | Mean CS |
| :---- | :---: | :---: | :-: | :---: |
| Qwen3-VL | 0.84 | 29.88 | 60.01 | 59.65 |
| Intern-VL | 0.98 | 30.02 | 61.18 | 55.19 |
| Galliena et al. (ICCV’25) | 1.12 | 39.78 | 70.00 | 81.98 |
| EPOS-VLM | **1.87** | **41.82** | **77.12** | **89.37** |
| EPOS-VLM w/o memory | 0.85 | 27.67 | 64.62 | 52.12 |
