...
<Figure>
  <Picture
    slot="figure"
    src={performance}
    alt="Two plots over 400 steps on HM3D test. Left: wall-clock time in seconds; EPOS-VLM stays near flat, point-cloud baseline increases. Right: memory in GB on log scale; EPOS-VLM stays orders of magnitude below the baseline plateau near 1 GB."
  />
  <span slot="caption">
